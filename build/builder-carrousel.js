...
async function main() {
  ...
  await groq.chat.completions.create({
    // Required parameters
    messages: [
        {role: "system", content: "Nous travaillons sur un générateur de composants Web rédige-moi un exemple de code source pour le composant carousel avec CDN bootstrap HTML+CSS.JS as bouton-exemple.html"},
